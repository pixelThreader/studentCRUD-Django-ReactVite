...
class Student(models.Model):
    ...
    profile_img = models.ImageField(upload_to="static/profiles", default="static/profiles/user.jpg", null=True)
    ...
    phone_num = models.CharField(max_length=60, default="xxxxxxxxxx", null=True)
    phone_num_alt = models.CharField(max_length=60, default="xxxxxxxxxx", null=True)
    phone_gardian = models.CharField(max_length=60, default="xxxxxxxxxx", null=True)
